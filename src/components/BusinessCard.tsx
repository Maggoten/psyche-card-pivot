...
const BusinessCard = ({ className = "" }: BusinessCardProps) => {
  ...
  return (
    <div className={`${isMobile ? 'h-screen landscape:overflow-hidden' : 'h-screen overflow-hidden'} w-full flex items-center justify-center ${isMobile ? 'p-4 landscape:py-2' : 'p-4'} ${className}`}>
