    ...
    <section className={`text-center ${className}`}>
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
        ...
        <div className="flex flex-col items-center space-y-3">
          ...
          <span className="font-body text-sm text-muted-foreground tracking-wide">Adobe</span>
        </div>
        ...
        <div className="flex flex-col items-center space-y-3">
          ...
          <span className="font-body text-sm text-muted-foreground tracking-wide">Microsoft</span>
        </div>
      </div>
    </section>
  );
